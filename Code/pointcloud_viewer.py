...
def POINTCLOUD_VIEWER():
    ...
    pcd =  o3d.io.read_point_cloud( "Reproduce_corner_result/Depth_3/data3/pcd_28.pcd")
    label = np.load("Reproduce_corner_result/Depth_3/data3/label_28.npy")
    est_label =  np.load("Reproduce_corner_result/Depth_3/result3/EM_DRG_est_label_28.npy")
