...
def POINTCLOUD_VIEWER():
    ...
    pcd =  o3d.io.read_point_cloud( "Reproduce_corner_result/Depth_3_R2.5_bgk0008/data3/pcd_19.pcd")
    label = np.load("Reproduce_corner_result/Depth_3_R2.5_bgk0008/data3/label_19.npy")
    est_label =  np.load("Reproduce_corner_result/Depth_3_R2.5_bgk0008/result3/EM_DRG_est_label_19.npy")
