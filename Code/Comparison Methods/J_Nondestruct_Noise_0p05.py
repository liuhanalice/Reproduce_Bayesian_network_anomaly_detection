...
def Experiments_of_Noise_Level(noise):
    ...
    for i in range(num_experiments):
        ...
        np.save('../EM_DRG_result/Noise_0p05/result3/J_Nondestruct_est_label_' + str(i), est_label)
    ...
    # np.save('./EM_DRG_result/Noise_0p05/result3/J_Nondestruct_FPR', FPR_vec)
    # np.save('./EM_DRG_result/Noise_0p05/result3/J_Nondestruct_FNR', FNR_vec)
