...
def Experiments_of_Noise_Level(noise):
    ...
    for i in range(num_experiments):
        ...
        np.save('../EM_DRG_result/Noise_0p10/result/EFA_est_label_' + str(i), est_label)
    ...
    np.save('./revision result/Noise_0p10/result/EFA_FPR', FPR_vec)
    np.save('./revision result/Noise_0p10/result/EFA_FNR', FNR_vec)
