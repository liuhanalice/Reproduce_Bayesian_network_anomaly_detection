...
def experiments_ratio(ratio):
    ...
    for i in range(num_experiments):
        ...
        np.save('../EM_DRG_result/Ratio_1p8/result/EFA_est_label_' + str(i), est_label)
    ...
    np.save('./revision result/Ratio_1p8/result/EFA_FPR', FPR_vec)
    np.save('./revision result/Ratio_1p8/result/EFA_FNR', FNR_vec)
