...
def experiments_ratio(ratio):
    print("Experiments of Ratio Range (EFA)!")
    print("Ratio:", ratio)
    num_experiments = 30
    ...
    for i in range(num_experiments):
        ...
        options = EM_options(0.0004, 0.01, 5, 4, ratio, cur_pos, bg_std_depth=0.10, step=-0.4, spline_flag=False)
        ...
        np.save('./revision_result/Ratio_1p4/result/EFA_est_label_' + str(i), est_label)
    ...
    np.save('./revision result/Ratio_1p4/result/EFA_FPR', FPR_vec)
    np.save('./revision result/Ratio_1p4/result/EFA_FNR', FNR_vec)
