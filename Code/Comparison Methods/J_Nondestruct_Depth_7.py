...
def experiments_depth(depth):
    ...
    for i in range(num_experiments):
        ...
        np.save('../EM_DRG_result/Depth_7/result3/J_Nondestruct_est_label_' + str(i), est_label)
    ...
    # np.save('./EM_DRG_result/Depth_7/result3/J_Nondestruct_FPR', FPR_vec)
    # np.save('./EM_DRG_result/Depth_7/result3/J_Nondestruct_FNR', FNR_vec)
