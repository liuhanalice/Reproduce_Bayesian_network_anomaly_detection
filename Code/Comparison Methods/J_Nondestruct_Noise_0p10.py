...
def Experiments_of_Noise_Level(noise):
    print("Experiments of Noise Level (J_Non_Eval_2017)!")
    ...
    for i in range(num_experiments):
        ...
        options = EM_options(0.0004, 0.01, 5, 4, 1.5, cur_pos, bg_std_depth=noise, step=-0.4,
                             spline_flag=False)
        ...
        np.save('../EM_DRG_result/Noise_0p10/result3/J_Nondestruct_est_label_' + str(i), est_label)
    ...
    # np.save('./EM_DRG_result/Noise_0p10/result3/J_Nondestruct_FPR', FPR_vec)
    # np.save('./EM_DRG_result/Noise_0p10/result3/J_Nondestruct_FNR', FNR_vec)
