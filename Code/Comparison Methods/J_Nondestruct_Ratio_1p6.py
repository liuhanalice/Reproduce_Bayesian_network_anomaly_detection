...
def experiments_ratio(ratio):
    print("Experiments of Ratio Range (J_Non_Eval_2017)!")
    print("Ratio:", ratio)
    ...
    for i in range(num_experiments):
        ...
        options = EM_options(0.0004, 0.01, 5, 4, ratio, cur_pos, bg_std_depth=0.10, step=-0.35,
                             spline_flag=False)
        ...
        np.save('../EM_DRG_result/Ratio_1p6/result3/J_Nondestruct_est_label_' + str(i), est_label)
    ...
    np.save('./EM_DRG_result/Ratio_1p6/result3/J_Nondestruct_FPR', FPR_vec)
    np.save('./EM_DRG_result/Ratio_1p6/result3/J_Nondestruct_FNR', FNR_vec)
